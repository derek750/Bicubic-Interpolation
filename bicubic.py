...
try:
    ...
    if len(sys.argv) != 2:
        raise Exception("Wrong usage: python bicubic.py path/to/1080p/image.png")
    ...
    output_file = os.path.join("./output", os.path.splitext(os.path.basename(input_file))[0]+'_upscaled.jpg')
